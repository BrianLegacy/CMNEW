...
@ManagedBean(name = "shortcodeController")
@ViewScoped
public class ShortcodeController implements Serializable {
...
//    public void setCurrentShortcode(ShortcodeModel selected) {
//        this.currentShortcode = selected;
//    }
    ...
    private void refreshShortcodes() {
        shortcodes = shortcodeDAO.fetchShortcodes();
    }
